...
public class AdminMeetingController {
  ...
  public AdminMeetingController(
      AdminMeetingService adminMeetingService, AdminAccessService adminAccessService) {
    this.adminMeetingService = adminMeetingService;
    this.adminAccessService = adminAccessService;
  }

  @GetMapping
  ApiResponse<List<AdminMeetingView>> meetings(HttpServletRequest servletRequest) {
  ...
  ApiResponse<AdminMeetingView> createMeeting(
    ...
    CreateMeetingCommand command =
        new CreateMeetingCommand(title, description, eventDateTime, priceAmount, capacity);
  ...
  ApiResponse<List<AdminMeetingApplicationView>> applications(
      HttpServletRequest servletRequest, @PathVariable Long meetingId) {
    adminAccessService.requireActiveAdmin(servletRequest);
  ...
  ApiResponse<AdminMeetingApplicationView> changeApplicationStatus(
    ...
    return ApiResponse.ok(
        adminMeetingService.changeApplicationStatus(
            meetingId,
            applicationId,
  ...
  ApiResponse<AdminMeetingApplicationView> changePaymentStatus(
    ...
    adminAccessService.requireActiveAdmin(servletRequest);
    return ApiResponse.ok(
        adminMeetingService.changePaymentStatus(
            meetingId,
            applicationId,
